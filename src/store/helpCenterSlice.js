...
const initialState = {
  ...
  questionItems: [
    ...
    {label: "How do I create an OpenSea account?"},
    {label: "How do creator earnings work on OpenSea?"},
