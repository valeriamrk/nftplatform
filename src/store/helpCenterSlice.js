...
const initialState = {
  helpCenterItems: [
    ...
    { title: "FAQ", description: "Learn answers to frequently asked questions on OpenOcean"},
    { title: "User Safety", description: "Learn more about anti-fraud and user safety processes on OpenOcean"},
    { title: "Partners", description: "Learn how you can partner with us to showcase your NFT drops"},
    { title: "Developers", description: "Learn how you can develop with OpenOcean"},
  ],
  questionItems: [
    ...
    {label: "What can I do if my art, image, or other IP is being sold without my permission?"},
