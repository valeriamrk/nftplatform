...
const OpenCard = (props) => {
  ...
  const accData = [
    {id: 1, title: "Price History", label: "Some history", icon: <MdTimeline/>},
    {id: 2, title: "Listings", label: "Some listings", icon: <MdLocalOffer/>},
  ...
  return (
    ...
    <S.OpenCardWrapper>
      ...
      <S.RightContainer>
        ...
        <S.OfferContainer><S.Flex><MyButton big><S.BtnIcon><MdLocalOffer/></S.BtnIcon>Make Offer</MyButton></S.Flex></S.OfferContainer>
